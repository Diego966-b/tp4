...
INSERT INTO `autos` (`Patente`, `Marca`, `Modelo`, `DniDuenio`) VALUES 
...
CREATE TABLE `persona` (
  ...
  `fechaNac` date NOT NULL default '0001-01-01',
...
ALTER TABLE `autos` ADD KEY `idTipoVehiculo` (`DniDuenio`);

ALTER TABLE `autos`
ADD CONSTRAINT `autos_ibfk_1` FOREIGN KEY (`DniDuenio`) REFERENCES `persona` (`NroDni`);
