...
class Persona
{
    private $nroDni, $apellido, $nombre, $fechaNac, $telefono, $domicilio, $mensajeOperacion;
    ...
    public function modificar(){
        ...
        $base=new BaseDatos();
        $sql=
        "UPDATE persona SET Apellido = '".$this->getApellido()."',Nombre = '".$this->getNombre()."',fechaNac = '".$this->getFechaNac()."',Telefono = '".$this->getTelefono()."',Domicilio = '".$this->getDomicilio()."'
