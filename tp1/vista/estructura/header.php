...
<!-- <head> -->
    ...
    <!-- jquery: -->
    <script src= <?php echo "/".$UTILS_TP1."/jquery/jquery-3.7.0.min.js"?>></script>
    <!-- Bootstrap css: -->
    <link type = "text/css" rel="stylesheet" href= <?php echo "/".$UTILS_TP1."/bootstrap/css/bootstrap.min.css"?>>
    <!-- Bootstrap js: -->
    <script src=<?php echo "/".$UTILS_TP1."/bootstrap/js/bootstrap.min.js" ?>></script>
    <!-- jquery validate: -->
    <script type="text/javascript" src= <?php echo "/".$UTILS_TP1."/jqueryValidate/jquery.validate.js" ?>></script>
<!-- </head> -->
